...
export interface IRoomCreateContext {
    errors: any;
    handleBlur: any;
    handleChange: any;
    isRepeated: boolean;
...
const defaultValue: IRoomCreateContext = {
    errors: {},
...
const RoomCreateContext = React.createContext(defaultValue);

export default RoomCreateContext;
