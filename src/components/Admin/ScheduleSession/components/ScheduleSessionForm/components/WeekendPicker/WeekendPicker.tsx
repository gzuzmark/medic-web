...
class WeekendPicker extends React.Component <IPropsWeekendPicker, IStateWeekendPicker> {
    ...
    private _renderBody(session: FactorySessionBean): JSX.Element[] {
        const firstSession = 420;
        const nextSession = session.factorySession.skillId === '1f541097-dc70-4852-a31a-f2956ab4fab4' ? 40 : 20;
        const lastSession = 1380;
        const duration = session.factorySession.skillId === '1f541097-dc70-4852-a31a-f2956ab4fab4' ? 40 : 15;
        const rows = [];
